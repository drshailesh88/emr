# DocAssist EMR - Gemini Instructions

Use this file as the primary project guide when working as Gemini.
If both `GEMINI.md` and `AGENTS.md` are present, keep them aligned.
